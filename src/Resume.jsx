  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.text}>
        Highly motivated 3rd year Computer Science student with strong programming, data structures,
        and algorithms skills. Eager to contribute to innovative projects and learn from industry
        leaders through an internship opportunity.
      </Text>
