...
import { PlusCircle, XCircle, User, Briefcase, GraduationCap, Code, FileCode } from 'lucide-react';
      ...
      <Tabs defaultValue="basics" className="w-full">
        ...
        <TabsContent value="basics" className="mt-0">
          <div className="glass-panel p-6">
            ...
            <div className="form-input-wrapper" style={{ animationDelay: '0.1s' }}>
              <label className="form-label" htmlFor="label">Professional Title</label>
              <input
                id="label"
                className="form-input"
